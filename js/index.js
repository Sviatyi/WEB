...
let url = "http://127.0.0.1:5000/get_articles";
const currentUrl = window.location.href;
if (currentUrl.includes("category=")){
    url += "_by_category/"+currentUrl.split("category=")[1];
}
...
jsonhttp.onload = function(){
    ...
    ${url === "http://127.0.0.1:5000/get_articles"? "Articles" : articles[0].category.toProperCase()} (${articles.length} results)`
